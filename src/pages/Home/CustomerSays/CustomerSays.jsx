    ...
    <div className="space-y-8 mt-16 md:mt-32 mb-8 md:mb-32">
      ...
      >
        ...
        <p className="text-gray-500">
          ...
          with our Action toys. From parents to teachers, their testimonials showcase the positive impact our toys
          have had on fun and Adventure. Discover why our customers are
