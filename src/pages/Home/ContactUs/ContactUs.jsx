    ...
    <div className="space-y-8 mt-16 md:mt-32 mb-8 md:mb-24">
      <div className="md:w-[70%] md:mx-auto text-center space-y-4">
        ...
        <p className="text-gray-500">
          ...
          need assistance with our Action toys, feel free to get in touch
          ...
          Action toy journey an exceptional one!
        </p>
      </div>
          ...
          <div className="card-body">
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-control mt-4">
                <button className="bg-gray-100 w-full text-green-600 font-semibold border rounded-full hover:bg-gray-200">
