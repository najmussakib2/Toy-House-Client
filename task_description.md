...
A company is seeking a web developer who can create a simple full-stack Toy Marketplace website. You are required to focus on a specific toy category, such as-
    ...
    - Action figure toys(marvel, avengers, tar Wars, transformers, etc.)
    ...
    - Electronic Toys, 
    - Lego sets(lego city, lego tar Wars, lego architecture, lego cars), 
...
5. **` Home page:`**
    ...
    > For example, if the website is based on **Educational and learning toys**, the sub-categories for the **3** tabs can be **Star Wars, Avengers, engineering toys, and Others, etc.**. You need at least 3 sub-categories.
    <br/>
...
9. **` Add A Toy page will be a private route:`** 
    ...
    - Sub-category ( For example: if the website is based on Educational and learning toys, the sub-categories can be Star Wars, Avengers, and Others.)
    - Price, 
    - Rating, 
    - Available quantity
    - Detail description
